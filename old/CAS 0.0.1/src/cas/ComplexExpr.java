...
public class ComplexExpr extends DoubleArgumentFunction {
	...
	public Expr derivative(Variable var) {
		return new ComplexExpr(getReal().derivative(var), getImag().derivative(var)).simplify();
	}
	...
	public Expr antiderivative(Variable var) {
		return new ComplexExpr(getReal().antiderivative(var), getImag().antiderivative(var)).simplify();
	}
	public Expr conjugate() {
		return new ComplexExpr(getReal(), getImag().negative()).simplify();
	}
