...
public class Complex extends NumComplexImaginary {
	...
	public Number conjugate() {
		return new Complex(real, (NumNumSum)imag.negative().simplify());
	}
	public Number magnitude() {
		return (Number)new Sqrt(real.square().plus(imag.square())).simplify();
	}
	public Number argument() {
		return (Number)new ArcTan2(real, imag).simplify();
	}
