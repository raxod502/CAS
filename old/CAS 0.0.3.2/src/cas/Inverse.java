...
public class Inverse extends SingleArgumentFunction {
	...
	public Expr simplifyFunction() {
		...
		if (getArgument() instanceof PolynomialTerm) {
			...
			return new PolynomialTerm((NumIntegerTranscendentalFunctionConstant)arg.coefficient.inverse().simplify(null), arg.variable, (Integer)arg.power.negative().simplify(null)).simplify();
		}
		// Variable
