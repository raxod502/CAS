...
public enum Compare {
	...
	public static Compare _and(Compare... comps) {
		...
		throw new AssertionError("Something went wrong in Compare.and.");
	}
	public static Compare _or(Compare... comps) {
		...
		if (no) return NO;
		if (maybe) return MAYBE;
		throw new AssertionError("Something went wrong in Compare.or.");
	}
	public static Compare _not(Compare comp) {
		...
		default: throw new AssertionError("Something went wrong in Compare.not.");
		}
	}
}
